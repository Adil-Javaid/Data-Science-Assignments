...
url2 = requests.get("https://www.britannica.com/on-this-day/October-25",headers=headers)
...
featured = soup2.find_all("div",attrs={"class":"description font-serif"})
more_event = soup2.find_all("div",attrs={"class":"card-body font-serif"})

featured_text = "\n\n".join(element.text.strip() for element in featured)
more_event_text = "\n\n".join(element.text.strip() for element in more_event)
